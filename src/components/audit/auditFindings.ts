    ...
    subSections: [
      {
        ...
        findings: [
          ...
          { id: "comp_local_runs_ads", label: "Konkurencja prowadzi reklamy platne", type: "issue", description: "Konkurencyjne salony inwestuja w reklamy Meta Ads i docieraja do nowych klientek w okolicy. Bez reklam tracisz potencjalne klientki.", recommendation: "Profesjonalne kampanie Meta Ads pozwalaja wyprzedzic konkurencje, ktora juz inwestuje w reklamy. Precyzyjne targetowanie lokalne dociera do klientek szukajacych uslug w okolicy." },
    ...
    subSections: [
      {
        ...
        findings: [
          ...
          { id: "ads_inactive", label: "Kampanie zostaly wylaczone", type: "issue", description: "Salon prowadzil kampanie, ale je wylaczyl. Brak ciaglości reklamowej oznacza utrate rozpędu i cieplej grupy odbiorcow.", recommendation: "Wznowienie kampanii pozwala odzyskac zebrane dane i ciepla grupe odbiorcow. Nawet kampanie z mniejszym budzetem utrzymuja widocznosc marki." },
      ...
      },
      {
        ...
        findings: [
          ...
          { id: "ads_low_budget", label: "Zbyt niski budzet reklamowy", type: "issue", description: "Budzet reklamowy jest zbyt niski, aby algorytm mial wystarczajaco duzo danych do optymalizacji kampanii.", recommendation: "Odpowiedni budzet reklamowy zalezy od lokalizacji, konkurencji i celow. Profesjonalna analiza pozwala dobrac optymalny budzet z najlepszym zwrotem z inwestycji." },
