    ...
    subSections: [
      {
        ...
        findings: [
          ...
          { id: "fb_cover_bad_crop", label: "Źle skadrowane zdjecie w tle", type: "issue", description: "Zdjecie w tle jest obciete w niefortunny sposob — ucieta glowa, polowa tekstu niewidoczna, wazne elementy poza kadrem.", recommendation: "Dopasuj zdjecie do wymiarow 820x312 px. Sprawdz jak wyglada na telefonie — kadr moze sie roznic od desktopu." },
          ...
          { id: "fb_slow_response", label: "Dlugi czas odpowiedzi na wiadomosci", type: "issue", description: "Salon odpowiada na wiadomosci po wielu godzinach lub dniach. Facebook pokazuje wskaznik 'Zwykle odpowiada w ciagu...' — dlugi czas zniecheca.", recommendation: "Odpowiadaj w ciagu 1-2 godzin. Ustaw automatyczna odpowiedz na godziny poza praca. Cel: odznaka 'Bardzo szybko odpowiada'." },
        ]
      },
      {
        id: "fb_posts",
        ...
        findings: [
          ...
          { id: "fb_posts_no_hook", label: "Brak hooka w pierwszym zdaniu", type: "issue", description: "Pierwsze zdanie posta nie przyciaga uwagi. W feedzie widac tylko 2-3 linijki — hook musi zatrzymac scrollowanie.", recommendation: "Zacznij od pytania, zaskakujacego faktu lub emocji: 'Czy wiesz, ze 70% kobiet zle dobiera kolor?'" },
          ...
          { id: "fb_posts_only_promos", label: "Same posty promocyjne i oferty", type: "issue", description: "Profil publikuje wylacznie promocje i oferty cenowe. Klientki nie chca feedu pelnego reklam — tracisz zaangazowanie.", recommendation: "Zasada 80/20: 80% tresci wartosciowych (porady, efekty, kulisy), 20% promocji. Ludzie obserwuja dla wartosci, nie reklam." },
      ...
      },
      {
        ...
        findings: [
          ...
          { id: "fb_photos_no_ba", label: "Brak zdjec before/after", type: "issue", description: "Profil nie prezentuje efektow pracy w formacie before/after — najskuteczniejszym formacie w branzy beauty.", recommendation: "Rob zdjecia before/after kazdej metamorfozy (za zgoda klientki). Te same warunki oswietlenia. Min. 2-3x/tydzien." },
          { id: "fb_photos_only_effects", label: "Same efekty pracy bez roznorodnosci", type: "issue", description: "Na profilu sa wylacznie zdjecia efektow pracy. Brakuje zdjec salonu, zespolu, kulis — profil jest monotonny.", recommendation: "Mix tresci: 40% efekty pracy, 25% edukacja, 20% kulisy, 15% oferty. Pokaz salon, siebie, zespol." },
    ...
    subSections: [
      {
        ...
        findings: [
          ...
          { id: "ig_bio_no_location", label: "Brak lokalizacji w bio", type: "issue", description: "W bio nie ma informacji o lokalizacji salonu. Klientka nie wie czy salon jest w jej miescie — scrolluje dalej.", recommendation: "Dodaj miasto lub dzielnice w bio. Lokalizacja to kluczowy filtr dla klientek szukajacych salonu w okolicy." },
          ...
          { id: "ig_link_homepage", label: "Link kieruje na strone glowna zamiast rezerwacji", type: "issue", description: "Link w bio kieruje na ogolna strone www salonu zamiast bezposrednio do rezerwacji. Klientka musi klikac dalej — czesc odpada.", recommendation: "Link w bio powinien prowadzic bezposrednio do rezerwacji lub Linktree z przyciskiem 'Umow wizyte' na gorze." },
          ...
          // Konto
          { id: "ig_not_business", label: "Konto osobiste zamiast firmowego", type: "issue", description: "Profil jest ustawiony jako konto osobiste — brak dostepu do statystyk, przyciskow kontaktowych i promocji.", recommendation: "Przejdz na konto firmowe lub twórcy w ustawieniach. Zyskasz statystyki, CTA i mozliwosc promowania postow." },
    ...
    subSections: [
      {
        ...
        findings: [
          ...
          { id: "content_copy_errors", label: "Bledy ortograficzne i gramatyczne w postach", type: "issue", description: "Posty zawieraja bledy ortograficzne i gramatyczne — obniza to postrzeganie profesjonalizmu salonu.", recommendation: "Sprawdzaj teksty przed publikacja. Uzyj narzedzi jak LanguageTool lub poproś kogoś o korekte." },
      ...
      },
      {
        ...
        findings: [
          ...
          { id: "content_photos_no_ba", label: "Brak zdjec before/after", type: "issue", description: "Profil nie pokazuje transformacji w formacie before/after — najskuteczniejszym formacie w branzy beauty.", recommendation: "Fotografuj kazda metamorfoze: before i after w tych samych warunkach. To Twoj najsilniejszy dowod jakosci." },
      ...
      },
      {
        ...
        findings: [
          ...
          { id: "content_freq_wrong_times", label: "Publikacje o zlych godzinach", type: "issue", description: "Posty sa publikowane o godzinach kiedy grupa docelowa nie jest aktywna — rano w poniedzialek lub poznym wieczorem.", recommendation: "Najlepsze godziny: 11-13 i 18-21. Sprawdz statystyki konta (Insights) — tam zobaczysz kiedy Twoi obserwujacy sa aktywni." },
    ...
    subSections: [
      {
        ...
        findings: [
          ...
          { id: "brand_logo_old", label: "Przestarzale logo z lat 90/2000", type: "issue", description: "Logo wyglada na stare — przestarzaly styl, efekty 3D, cienie, niezgrabna czcionka. Nie pasuje do nowoczesnego salonu.", recommendation: "Odswierz logo — nowoczesny, minimalistyczny styl. Proste linie, czytelna czcionka, max 2 kolory." },
    ...
    subSections: [
      {
        ...
        findings: [
          ...
          { id: "comp_local_runs_ads", label: "Konkurencja prowadzi reklamy platne", type: "issue", description: "Konkurencyjne salony inwestuja w reklamy Meta Ads — docieraja do nowych klientek w okolicy. Bez reklam tracisz potencjalne klientki.", recommendation: "Zacznij od reklam na zasieg lub wiadomosci. Min. 10-20 zl/dzien. Targetuj kobiety w promieniu 10-15 km." },
      ...
      },
      {
        ...
        findings: [
          ...
          { id: "comp_pos_copycat", label: "Kopiowanie stylu konkurencji zamiast wlasnego", type: "issue", description: "Salon kopiuje styl komunikacji konkurencji zamiast rozwijac wlasny glos. Klientki widza 'kopia' zamiast oryginalu.", recommendation: "Inspiruj sie, ale nie kopiuj. Znajdz SWOJ styl, SWOJ glos, SWOJA unikalna cechę. Oryginalnosc przyciaga." },
        ]
      },
      {
    ...
    subSections: [
      {
        ...
        findings: [
          ...
          { id: "ads_old_creatives", label: "Te same kreacje od miesiecy", type: "issue", description: "Reklamy uzywaja tych samych zdjec i tekstow od dlugiego czasu — grupa docelowa jest znuzona, CTR spada.", recommendation: "Odswiezaj kreacje co 2-4 tygodnie. Nowe zdjecia, nowe naglowki, nowe CTA. Testyj co dziala najlepiej." },
